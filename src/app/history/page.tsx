  ...
  return (
    <AuthCheck>
      <div className="min-h-[85vh]">
        <h1 className="text-dark text-2xl font-extrabold mb-8 px-12 sm:pl-24 pt-8">자기소개서 기록</h1>
          <div className="flex h-fit relative">
            ...
            <div
              className={`
                h-[85vh] mb-4 transition-width duration-300 ease-in-out
                ${collapsed ? 'w-0' : 'w-[100vw]'}
                sm:max-w-[300px] min-w-fit flex-shrink-0
              `}
            >
              {!collapsed && (
                <div className="overflow-y-scroll h-full pr-2 bg-gray-100 border-r py-2 pl-6 sm:min-w-[25vw] sm:max-w-[30vw]">
                    ...
                    generations.map((gen, index) => {
                      ...
                      if (gen.type == 'job') {
                        ...
                        return (
                          ...
                          >
                            <div className={`ml-2 px-4 py-2 cursor-pointer rounded-l ${isSelected ? 'bg-primary/20 font-bold mr-[-0.5rem]' : 'hover:bg-primary/10'}`}>
            ...
            {/* Content area */}
            <div className={`h-[85vh] flex flex-col items-center justify-start flex-grow transition-all duration-300 ease-in-out ${collapsed ? 'w-[100vw]' : 'w-[60vw]'}`}>
              <div className={`popped flex flex-col rounded-lg border border-gray-500 ${collapsed ? 'w-[95vw] sm:w-[60vw]' : 'w-[60vw]'} `}>
                <div className={`flex bg-primary/60 p-[0.2rem] rounded-t-lg border-b border-gray-500`}>
                  <div
                ...
                <div className={`bg-light rounded-b-lg`}>
                  {selectedGen ? (
                    <div className="bg-white py-8 px-4 sm:px-16 h-[75vh] rounded-b-lg flex flex-col gap-2 sm:gap-8 overflow-y-scroll">
