    ...
    <div className="container mx-auto p-6 md:p-10 lg:p-12 max-w-4xl bg-white shadow-lg rounded-lg my-8">
      <header className="text-center mb-10">
        ...
        <p className="text-sm text-gray-500">
          ...
          <span className="block md:inline md:ml-4">최종 수정일자: 2025년 07월 23일</span>
        </p>
      </header>
      ...
      <section className="mb-8">
        ...
        <div className="mb-6">
          ...
          <ul className="list-disc pl-5 text-gray-600 space-y-1">
            ...
            <li>쿠키(Cookie) 및 유사 기술을 사용하여 서비스 이용 기록 및 방문 분석 (Google Analytics, Meta Pixel 등 포함)</li> 
          </ul>
        </div>
      </section>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-5 text-gray-600 space-y-1">
          ...
          <li>서비스 관련 주요 공지, 업데이트, 이벤트 등 마케팅 정보 전달 (동의 시)</li>
          <li>서비스 개선, 신규 기능 개발, 통계 분석, 그리고 광고 및 홍보 목적 (개인 식별 불가능한 형태로 가공하여 사용)</li>
        </ul>
      </section>
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full bg-white border border-gray-200 rounded-lg">
              ...
              <tbody className="divide-y divide-gray-100">
                ...
                <tr>
                  <td className="py-3 px-4 text-gray-600">Meta Platforms (Facebook, Instagram)</td>
                  <td className="py-3 px-4 text-gray-600">이름, 이메일 주소, 전화번호 등 광고 캠페인 목적에 따라 수집된 개인정보</td>
                  <td className="py-3 px-4 text-gray-600">리드 생성, 광고 효과 측정 및 분석, 잠재 고객 확보 지원</td>
                </tr>
                <tr>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-bold text-gray-700 mb-4">8. 개인정보 보호 책임자</h2>
      ...
      <section>
        <h2 className="text-2xl font-bold text-gray-700 mb-4">9. 정책 변경에 대한 고지</h2>
